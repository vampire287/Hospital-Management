...
{
    int Patient_ID;
    char Name[MAX];d:\My desktop\HOspital_Management.C
    char Dept[MAX];
    ...
    int Fee_due;
    int Age;d:\My desktop\HOspital_Management.C
    char blood[MAX];d:\My desktop\HOspital_Management.C
    char PhNo[MAX];
    char available;
